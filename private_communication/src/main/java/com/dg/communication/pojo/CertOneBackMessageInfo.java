 ...
 * @author: XBin
 * @description: 第一次向存证系统发送信息返回的实体类
 * @createTime: 2024-01-09 10:44
 */
@Data
public class CertOneBackMessageInfo {
     ...
     */
    private String responsetime = getLocalTime("yyyy-MM-dd HH:mm:ss");
    ...
    /**
     * 随机标识（密文字段），确保存证上报前做过请求应答（完整版的存证信息需要这个字段）
     */
    ...
    public String getLocalTime(String timeFormatter){
