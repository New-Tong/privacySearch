...
def query_database(cur2):

    query_ins = "SELECT * FROM sada_gdpi_click_dtl_dgut_ins"
    #                          sada_gdpi_click_dtl_dgut_ins_copy
    ...
    # 处理新增、删除、更新数据
    if ins_results:
        handle_insert(ins_results, cur2)
        query_clear = "delete from sada_gdpi_click_dtl_dgut_ins"
...
# 处理插入
def handle_insert(results, cur2):
